...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
            ...
            @endif
                <div id="contact_form">
                   <form method="post" name="contact" action="{{ route('user.doLogin') }}">
                    @csrf
                        ...
                        <input type="submit" class="submit_btn" name="submit" id="submit" value="Se connecter" /><br>
                        <p>Pas de compte? <a href="{{ route('user.register') }}">cliquez ici</a><br/></p>
                    </form>
                </div>
            </div>
